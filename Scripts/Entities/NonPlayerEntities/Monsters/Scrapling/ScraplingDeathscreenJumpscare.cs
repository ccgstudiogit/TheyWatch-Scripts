...
public class ScraplingDeathscreenJumpscare : DeathscreenJumpscareBase
{
    [Header("Look At Scrapling Settings")]
    [Tooltip("The speed at which the player looks at this Scrapling's head")]
