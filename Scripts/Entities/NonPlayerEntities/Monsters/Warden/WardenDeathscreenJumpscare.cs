...
public class WardenDeathscreenJumpscare : DeathscreenJumpscareBase
{
    [Header("Look At Warden Settings")]
    [Tooltip("The speed at which the player looks at Warden's head")]
    ...
    private IEnumerator DeathscreenJumpscareRoutine(PlayerReferences playerReferences, Monster monster)
    {
        ...
        if (useLookDownAnim && animator != null && gameObject.TryGetComponent(out LookAtTarget lookAtTarget))
        {
