...
public class SomnidDeathscreenJumpscare : DeathscreenJumpscareBase
{
    [Header("Look At Somnid Settings")]
    [Tooltip("The speed at which the player looks at this Somnid's head")]
